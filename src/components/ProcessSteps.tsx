      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {steps.map((s) => (
            <div
              key={s.step}
              className="relative p-8 rounded-2xl border border-[#E5E7EB] bg-white hover:-translate-y-0.5 transition-all duration-150"
            >
              <div className="text-xs font-mono text-[#10B981] font-semibold mb-4">
                STEP {s.step}
              </div>
              <div className="w-12 h-12 rounded-xl bg-[#10B981]/10 flex items-center justify-center mb-5">
                <s.icon className="w-6 h-6 text-[#10B981]" />
              </div>
              <h3 className="font-heading text-xl font-semibold text-[#1F2937] mb-3">
                {s.title}
              </h3>
