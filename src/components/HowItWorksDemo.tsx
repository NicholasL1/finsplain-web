...
export default function HowItWorksDemo() {
  ...
  // IntersectionObserver: auto-play when scrolled into view, reset when scrolled away
  useEffect(() => {
        ...
        <div>
          ...
          <div className="bg-amber-500/10 border-b border-amber-500/30 px-6 py-3 flex items-center justify-between gap-4">
            <p className="text-sm text-amber-800 dark:text-amber-300">
              <span className="font-semibold">Sample data</span> — this is what
              your analysis looks like. Sign up to analyze your own documents.
            </p>
            <Link
              href="/sign-up"
